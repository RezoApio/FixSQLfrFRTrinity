...
--lettre consacrée
INSERT INTO quest_request_items_locale (ID, locale, CompletionText, VerifiedBuild) values (3101, 'frFR', 'Enfin ! Nous sommes face à face, de frère à frère. Bienvenue à Comté-du-Nord, qui sera votre foyer le temps d''apprendre les ficelles du métier. Mais sachez que Hurlevent n''est pas loin et tôt ou tard, votre chemin vous y ménera. En attendant, soyez patient... chevalier de la Main d''Argent', 19091);
